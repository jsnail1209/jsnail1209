...
<table>
  ...
  <tr>
    <td>2024년</td>
    <td rowspan="2">케어메디: 의료SW QA(24.05~25.12)</td>
    <td>컴활 1급 취득(04.19)</td>
    <!-- <td></td> -->
  </tr>
  
  <tr>
    <td>2025년</td>
    <td>학점은행제 학점 취득중(컴퓨터공학과)</td>
    <!-- <td></td> -->
  </tr>
  
  <tr>
    <td rowspan="4">2026년</td>
    <td></td>
    <td>ISTQB CTFL 취득(06.18)</td>
    <!-- <td></td> -->
  </tr>
  <!-- <tr>
    <td></td>
...
동아방송예술대 뉴미디어콘텐츠 전공(20.02 ~ 24.02)
<table>
  <tr>
    <th></th>
    <th>개발</th>
  ...
  <tr>
    <td></td>
    <td><a href = "https://github.com/jsnail1209/logic" target="_blank">논리학 공부</a></td>
  </tr>
  ...
  <tr>
    <td></td>
    <td><a href = "https://www.youtube.com/watch?v=nqQOLxQCYNM" target="_blank">AfterEffect: 에어택시 홍보 영상 제작</a></td>
  </tr>
    <tr>
  ...
  <tr>
    <td><a href = "https://github.com/jsnail1209/AndroidStudio" target="_blank">Android Studio(Java)</a></td>
    <td></td>
  </tr>
  <tr>
    <td><a href = "https://github.com/jsnail1209/wunderkammer" target="_blank">Unity: 경기아트센터 메타버스 프로젝트</a></td>
    <td></td>
  </tr>
</table>
